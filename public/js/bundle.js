...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWthc2g1NCIsImEiOiJjazJ3ZW1pNmIwMTJxM21vbW4xOGtqOXRwIn0.tNpkzST7tf0qFFxMcaKzGA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.day, ": ").concat(loc.description)).addTo(map);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error in logging out! please Try again');
...
var stripe = Stripe('pk_test_tGmW1UXUcfgglHn87YJ0aWZ100p4bGXv5N');
